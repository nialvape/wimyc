...
El texto puede venir de un dictado y traer errores. Corregí nombres propios de calles y lugares
rioplatenses al escribirlos en "description": "cabilo" -> "Cabildo", "escala brini ortiz" ->
"Scalabrini Ortiz", "puerto madero" -> "Puerto Madero", "santa fe" -> "Santa Fe".
 ...
 *
 * Ante un JSON inválido reintenta una vez; si tampoco sirve, devuelve
 * `unknown` en vez de tirar: el usuario prefiere "no te entendí" a un error.
 */
